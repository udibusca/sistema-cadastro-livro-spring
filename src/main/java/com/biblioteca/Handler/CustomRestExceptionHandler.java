package com.biblioteca.Handler;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(final HttpMediaTypeNotSupportedException ex, final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
        ...
        builder.append(" o tipo de mídia não é suportado. Tipos de mídia suportados são ");
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(final DataIntegrityViolationException ex, final WebRequest request) {
        ...
        final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, ex.getLocalizedMessage(), 
        		"Item não pode ser excluido, pois está vinculado a outro cadastro.");
        return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
    }
